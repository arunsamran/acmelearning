...
function education_upgrade_notice() {
	$message = sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'education' ), $GLOBALS['wp_version'] );
...
function education_customize() {
	wp_die( sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'education' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function education_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Seventeen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'education' ), $GLOBALS['wp_version'] ) );
	}
}
