 ...
 */
function acmelearning_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'acmelearning_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.acmelearning-front-page) .entry-title,
...
.colors-custom .acmelearning-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.acmelearning-front-page .panel-content .recent-posts article,
...
.colors-custom.acmelearning-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'acmelearning_custom_colors_css', $css, $hue, $saturation );
}
