...
if ( $nd_learning_customizer_archive_courses_header_image_display != 1 ) { ?>
	...
	<div class="nd_learning_section nd_learning_background_size_cover <?php echo $nd_learning_customizer_archive_courses_header_image_position; ?> nd_learning_bg_greydark" style="background-image:url(<?php echo $nd_learning_customizer_archive_courses_header_image; ?>);">
    ...
    <?php do_action('nd_learning_end_header_img_archive_courses_hook'); ?>
...
if( isset($_GET['nd_learning_arrive_from_advsearch']) ) { $nd_learning_arrive_from_advsearch = $_GET['nd_learning_arrive_from_advsearch']; } else { $nd_learning_arrive_from_advsearch = ''; }
