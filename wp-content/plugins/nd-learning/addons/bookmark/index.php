...
function nd_learning_add_bookmark_button(){
  ...
  //heart image
  $nd_learning_empty_heart = plugins_url().'/nd-learning/assets/img/icons/icon-heart-empty-white.svg';
  $nd_learning_full_heart = plugins_url().'/nd-learning/assets/img/icons/icon-heart-full-white.svg';
  ...
  if (is_user_logged_in() == 1){
      ...
      wp_enqueue_script( 'nd_learning_bookmark', plugins_url() . '/nd-learning/addons/bookmark/js/nd_learning_add_to_bookmark.js', array( 'jquery' ) ); 

      //ajax nd_learning_bookmark only if the shortcode is used
      wp_localize_script( 'nd_learning_bookmark', 'nd_learning_my_vars_add_to_bookmark', array( 'nd_learning_ajaxurl_add_to_bookmark'   => admin_url( 'admin-ajax.php' )) ); 
      ...
      if ( nd_learning_is_course_bookmarked( get_the_ID(), $nd_learning_current_user_id, $nd_learning_action_type ) == 0 ){
        ...
        $nd_learning_img_to_return = "'".plugins_url()."/nd-learning/assets/img/icons/icon-heart-full-white.svg"."'";
...
function nd_learning_show_bookmark(){
  ...
  if ( empty($nd_learning_course_ids) ) { 
    ...
    //call js only if the shortcode is used
    wp_enqueue_script( 'nd_learning_remove_bookmark', plugins_url() . '/nd-learning/addons/bookmark/js/nd_learning_remove_to_bookmark.js', array( 'jquery' ) ); 

    //ajax nd_learning_bookmark only if the shortcode is used
    wp_localize_script( 'nd_learning_remove_bookmark', 'nd_learning_my_vars_remove_to_bookmark', array( 'nd_learning_ajaxurl_remove_to_bookmark'   => admin_url( 'admin-ajax.php' )) ); 
...
add_action( 'wp_ajax_nopriv_nd_learning_bookmark_php_function', 'nd_learning_bookmark_php_function' );
//END
...
add_action( 'wp_ajax_nopriv_nd_learning_remove_bookmark_php_function', 'nd_learning_remove_bookmark_php_function' );
//END
