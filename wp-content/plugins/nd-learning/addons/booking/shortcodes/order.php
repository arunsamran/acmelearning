...
function nd_learning_shortcode_order() {
  ...
  if ( isset($_POST['nd_learning_review_number']) ) {
    ...
    //recover order info
    $nd_learning_order_id = $_POST['nd_learning_order_id'];
    $nd_learning_order_course_id = $_POST['nd_learning_order_course_id'];
    $nd_learning_order_user_id = $_POST['nd_learning_order_user_id'];
    $nd_learning_order_user_first_name = $_POST['nd_learning_order_user_first_name'];
    $nd_learning_order_user_last_name = $_POST['nd_learning_order_user_last_name'];
    $nd_learning_order_user_email = $_POST['nd_learning_order_user_email'];
