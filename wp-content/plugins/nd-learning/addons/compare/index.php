            ...
            <div class="nd_learning_section nd_learning_position_relative">
                ...
                <div class="nd_learning_bg_greydark_alpha_gradient_3 nd_learning_position_absolute nd_learning_left_0 nd_learning_height_100_percentage nd_learning_width_100_percentage nd_learning_padding_20 nd_learning_box_sizing_border_box">
                  <div class="nd_learning_position_absolute nd_learning_right_20 nd_learning_bottom_20">
                      <a href="'.nd_learning_get_account_page().'#nd_learning_account_page_tab_compare"><img class="nd_learning_float_right" alt="" width="20" height="20" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-trash-white.svg"></a>   
                  </div>
...
function nd_learning_add_compare_button(){
  ...
  //compare image
  $nd_learning_empty_compare = plugins_url().'/nd-learning/assets/img/icons/icon-compare-empty-white.svg';
  $nd_learning_none_compare = plugins_url().'/nd-learning/assets/img/icons/icon-compare-none-white.svg';
  $nd_learning_full_compare = plugins_url().'/nd-learning/assets/img/icons/icon-compare-full-white.svg';
  ...
  if (is_user_logged_in() == 1){
      ...
      //call js only if the shortcode is used
      wp_enqueue_script( 'nd_learning_compare', plugins_url() . '/nd-learning/addons/compare/js/nd_learning_add_to_compare.js', array( 'jquery' ) ); 

      //ajax nd_learning_compare only if the shortcode is used
      wp_localize_script( 'nd_learning_compare', 'nd_learning_my_vars_add_to_compare', array( 'nd_learning_ajaxurl_add_to_compare'   => admin_url( 'admin-ajax.php' )) ); 
      ...
      if ( nd_learning_is_course_compareed( get_the_ID(), $nd_learning_current_user_id, $nd_learning_action_type ) == 0 ){
        ...
        $nd_learning_img_to_return_none = "'".plugins_url()."/nd-learning/assets/img/icons/icon-compare-none-white.svg"."'";
        $nd_learning_img_to_return_full = "'".plugins_url()."/nd-learning/assets/img/icons/icon-compare-full-white.svg"."'";
...
function nd_learning_show_compare(){
  ...
  if ( empty($nd_learning_course_ids) ) { 
    ...
    //call js only if the shortcode is used
    wp_enqueue_script( 'nd_learning_remove_compare', plugins_url() . '/nd-learning/addons/compare/js/nd_learning_remove_to_compare.js', array( 'jquery' ) ); 

    //ajax nd_learning_compare only if the shortcode is used
    wp_localize_script( 'nd_learning_remove_compare', 'nd_learning_my_vars_remove_to_compare', array( 'nd_learning_ajaxurl_remove_to_compare'   => admin_url( 'admin-ajax.php' )) ); 
...
function nd_learning_compare_php_function() {
  ...
  //recover datas
  $nd_learning_course_id = $_GET['nd_learning_course_id'];
  $nd_learning_user_id = $_GET['nd_learning_user_id'];
  $nd_learning_action_type = $_GET['nd_learning_action_type'];
...
add_action( 'wp_ajax_nopriv_nd_learning_compare_php_function', 'nd_learning_compare_php_function' );
//END
...
add_action( 'wp_ajax_nopriv_nd_learning_remove_compare_php_function', 'nd_learning_remove_compare_php_function' );
//END
