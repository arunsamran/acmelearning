        ...
        <div class="nd_learning_position_absolute nd_learning_bottom_20">
            ...
            <div class="nd_learning_display_table nd_learning_float_left nd_learning_margin_right_20">
                ...
                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <img alt="" class="nd_learning_float_left nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle" width="20" height="20" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-calendar-white.svg">
                </div>
            ...
            <div class="nd_learning_display_table nd_learning_float_left">
                ...
                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <img alt="" class="nd_learning_float_left nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle" width="20" height="20" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-clock-white.svg">
                </div>
            ...
            <div class="nd_learning_section nd_learning_border_1_solid_grey">
                ...
                <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_bg_grey nd_learning_border_top_1_solid_grey">
                    ...
                    <div class="nd_learning_width_33_percentage nd_learning_display_none_all_iphone nd_learning_float_left">
                        <div class="nd_learning_display_table nd_learning_float_left">
                            <img alt="" class="nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle nd_learning_border_radius_100_percentage" width="23" height="23" src="'.plugins_url().'/nd-learning/addons/visualcomposer/courses/img/icon-availability.svg">
