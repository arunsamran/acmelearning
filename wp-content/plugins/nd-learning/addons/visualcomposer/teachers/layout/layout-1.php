...
if ( $nd_learning_meta_box_teacher_social_facebook == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_facebook.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/facebook.svg"></a>';
}
//twitter
...
if ( $nd_learning_meta_box_teacher_social_twitter == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_twitter.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/twitter.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_instagram == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_instagram.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/instagram.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_pinterest == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_pinterest.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/pinterest.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_googleplus == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_googleplus.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/googleplus.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_youtube == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_youtube.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/youtube.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_linkedin == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_linkedin.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/linkedin.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_vimeo == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_vimeo.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/vimeo.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_behance == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_behance.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/behance.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_dribbble == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_dribbble.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/dribbble.svg"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_github == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_github.'"><img alt="" width="15" height="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.plugins_url().'/nd-learning/inc/metabox/social/github.svg"></a>';
}
