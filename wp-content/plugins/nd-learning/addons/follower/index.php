...
function nd_learning_single_teacher_header_info_btn_follower(){
  ...
  if (is_user_logged_in() == 1){
      ...
      if ( nd_learning_is_teacher_followed( get_the_ID(), $nd_learning_current_user_id, $nd_learning_action_type ) == 0 ){
        ...
        wp_enqueue_script( 'nd_learning_remove_follower', plugins_url() . '/nd-learning/addons/follower/js/nd_learning_remove_follower.js', array( 'jquery' ) ); 
        wp_localize_script( 'nd_learning_remove_follower', 'nd_learning_my_vars_remove_follower', array( 'nd_learning_ajaxurl_remove_follower'   => admin_url( 'admin-ajax.php' )) ); 
        ...
        wp_enqueue_script( 'nd_learning_followers', plugins_url() . '/nd-learning/addons/follower/js/nd_learning_add_follower.js', array( 'jquery' ) ); 
        wp_localize_script( 'nd_learning_followers', 'nd_learning_my_vars_add_follower', array( 'nd_learning_ajaxurl_add_follower'   => admin_url( 'admin-ajax.php' )) ); 
...
function nd_learning_followers_php_function() {
  ...
  //recover datas
  $nd_learning_teacher_id = $_GET['nd_learning_teacher_id'];
...
add_action( 'wp_ajax_nopriv_nd_learning_followers_php_function', 'nd_learning_followers_php_function' );
//END
...
add_action( 'wp_ajax_nopriv_nd_learning_remove_follower_php_function', 'nd_learning_remove_follower_php_function' );
//END
