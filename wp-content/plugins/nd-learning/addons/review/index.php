...
function nd_learning_add_review_on_db(){
  ...
  //recover values
  $nd_learning_review_order_id = $_POST['nd_learning_review_order_id'];
  $nd_learning_review_course_id = $_POST['nd_learning_review_course_id'];
  $nd_learning_review_user_id = $_POST['nd_learning_review_user_id'];
  $nd_learning_review_number = $_POST['nd_learning_review_number'];
  $nd_learning_review_text = $_POST['nd_learning_review_text'];
