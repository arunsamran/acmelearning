    ...
    if ( isset($_POST['nd_learning_edit_record']) ) {
      ...
      $nd_learning_edit_record = $wpdb->update( 
        ...
        array( 
          ...
          'paypal_payment_status' => $_POST['nd_learning_order_info_paypal_payment_status'], 
          'paypal_email' => $_POST['nd_learning_order_info_paypal_email'],
          'paypal_tx' => $_POST['nd_learning_order_info_paypal_tx'],
          'id_user' => $_POST['nd_learning_order_info_id_user'],
          'user_country' => $_POST['nd_learning_order_info_user_country'],
          'user_address' => $_POST['nd_learning_order_info_user_address'],
          'user_first_name' => $_POST['nd_learning_order_info_user_first_name'],
          'user_last_name' => $_POST['nd_learning_order_info_user_last_name'],
          'user_city' => $_POST['nd_learning_order_info_user_city'],
        ),
