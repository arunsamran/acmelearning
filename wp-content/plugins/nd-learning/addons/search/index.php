...
';
  ...
  $nd_learning_result .= '
    ...
    <div class="nd_learning_section nd_learning_padding_15 nd_learning_box_sizing_border_box">
      <h2><strong>'.$nd_learning_qnt_results_posts.' '.__('results','nd-learning').'</strong></h2>
    </div>
  ...
  $nd_learning_result .= '
    ...
    <!--START btns order-->
    <div class="nd_learning_section nd_learning_padding_15 nd_learning_box_sizing_border_box nd_learning_text_align_right">
  ...
  while ( $the_query->have_posts() ) : $the_query->the_post();
      ...
      include "preview-layout/grid/layout-1.php"; 
...
function nd_learning_courses_sorting_php() {
  ...
  while ( $the_query->have_posts() ) : $the_query->the_post();
      ...
      if ( $nd_learning_layout == 1 ) {
        include "preview-layout/list/layout-1.php";
      }else{
        include "preview-layout/grid/layout-1.php";
      }
