                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="nd_learning_text_align_center">
                      <img width="25" height="25" src="<?php echo plugins_url(); ?>/nd-learning/assets/img/icons/icon-yes.svg">
                    </td>
                    <td class="nd_learning_text_align_center">
                      <img width="25" height="25" src="<?php echo plugins_url(); ?>/nd-learning/assets/img/icons/icon-yes.svg">
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="nd_learning_text_align_center">
                      <img width="25" height="25" src="<?php echo plugins_url(); ?>/nd-learning/assets/img/icons/icon-not.svg">
                    </td>
                    <td class="nd_learning_text_align_center">
                      <img width="25" height="25" src="<?php echo plugins_url(); ?>/nd-learning/assets/img/icons/icon-yes.svg">
                    </td>
