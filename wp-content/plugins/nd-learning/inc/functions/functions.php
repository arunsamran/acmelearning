...
function nd_learning_course_review_star($nd_learning_review_number,$nd_learning_star_size,$nd_learning_star_color,$nd_learning_star_margin){
	...
	while ( $nd_learning_review_i <= $nd_learning_review_number ) {
		...
		$nd_learning_review_images .= '<img alt="" style="margin:'.$nd_learning_star_margin.';" width="'.$nd_learning_star_size.'" height="'.$nd_learning_star_size.'" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-star-full-'.$nd_learning_star_color.'.svg">' ;
	...
	if ($nd_learning_dot == true) {
		$nd_learning_review_images .= '<img alt="" style="margin:'.$nd_learning_star_margin.';" width="'.$nd_learning_star_size.'" height="'.$nd_learning_star_size.'" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-star-half-'.$nd_learning_star_color.'.svg">' ;
	}
	...
	while ( $nd_learning_review_i <= $nd_learning_review_number_empty ) {
		...
		$nd_learning_review_images .= '<img alt="" style="margin:'.$nd_learning_star_margin.';" width="'.$nd_learning_star_size.'" height="'.$nd_learning_star_size.'" src="'.plugins_url().'/nd-learning/assets/img/icons/icon-star-empty-'.$nd_learning_star_color.'.svg">' ;
